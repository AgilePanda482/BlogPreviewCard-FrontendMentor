# 📦 Blog Preview Card – Frontend Mentor (Monorepo)

This repository contains two implementations of the **"Blog Preview"** card challenge from [Frontend Mentor](https://www.frontendmentor.io/challenges/blog-preview-card-ckPaj01IcS), organized in a **monorepo** structure.
...
```bash
git clone https://github.com/AgilePanda482/BlogPreviewCard-FrontendMentor.git
...
This project is based on the [Blog preview card](BlogPreviewCard-FrontendMentor) from Frontend Mentor. The challenge focuses on:
